...
import com.sadge.devbhoomi_uttarakhand.data.PlanItem

class PlanAdapter(private val images: ArrayList<PlanItem>, private val context: Context):
    RecyclerView.Adapter<PlanAdapter.ViewHolder>() {
    class ViewHolder(itemView : View): RecyclerView.ViewHolder(itemView) {
        val image: ImageView = itemView.findViewById(R.id.planImage)
